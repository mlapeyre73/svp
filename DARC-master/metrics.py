...
def main():
    ...
    AT = pd.read_csv('./data/ground_truth_new_generalized_date_hours_id_item_twoLastDigits_pricePercentile_qtyPercentile.csv', sep=',', engine='c', na_filter=False, low_memory=False)
    ...
    ### Utility Metrics ###
    #######################
    file=open(os.path.expanduser("data/results/ground_truth_new_generalized_date_hours_id_item_twoLastDigits_pricePercentile_qtyPercentile.txt"),"w")
