...
def main():
    ...
    AT = pd.read_csv('./data/ground_truthground_truth_id_user_hashsalte1sur20_date_hours_uniq_id_item_Delete5_price_percent20000_qty_percent20000.csv', sep=',', engine='c', na_filter=False, low_memory=False)
    ...
    filepathout=os.path.expanduser("data/results/ground_truthground_truth_id_user_hashsalte1sur20_date_hours_uniq_id_item_Delete5_price_percent20000_qty_percent20000.txt")
