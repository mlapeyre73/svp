...
records = pickle.load(open("ground_truth_new_generalized_date_hours_id_item_twoLastDigits_pricePercentile_qtyPercentile_50000.p", "r+b"))
...
plot_kmap(data=data2, data_label="date, hours, id_item, price, qty", filename=os.path.expanduser("images/ground_truth_new_generalized_date_hours_id_item_twoLastDigits_pricePercentile_qtyPercentile_50000=5"), plot_annotation=[[1, 3], [100, 1000]], colormap=plt.cm.viridis)
